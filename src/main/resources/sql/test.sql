...
-- ----------------------------
INSERT INTO `oauth_client_details` VALUES ('client_test', 'rid', '1233', 'all', 'password,refresh_token,authorization_code,client_credentials', 'www.baidu.com', '*', 213132, 464654654, NULL, NULL);
